        ...
        <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between text-sm">
            ...
            <div className="flex items-center space-x-2 lg:space-x-4">
              {/* Facebook */}
              <a href="https://www.facebook.com/ntcogk" target="_blank" rel="noopener noreferrer" className="hover:text-[#E02020] transition-colors" title="Facebook - @ntcogk">
              ...
              {/* X (Twitter) */}
              <a href="https://twitter.com/ntcogk" target="_blank" rel="noopener noreferrer" className="hover:text-[#E02020] transition-colors" title="X (Twitter) - @ntcogk">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* TikTok */}
              <a href="https://www.tiktok.com/@ntcogk" target="_blank" rel="noopener noreferrer" className="hover:text-[#E02020] transition-colors" title="TikTok - @ntcogk">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              ...
              {/* YouTube */}
              <a href="https://www.youtube.com/@ntcogk" target="_blank" rel="noopener noreferrer" className="hover:text-[#E02020] transition-colors" title="YouTube - @ntcogk">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
